              ...
              <Panel>
                ...
                <Body>
                  <div className="body-formatting">
                    ...
                    <p>This guide uses <a href="https://github.com/facebook/create-react-app">create-react-app</a> as a boiler-plate and base for a React application.</p>
                    <p>Depending on your areas needs, this may be enough. However every team/person needs to take into consideration future functionality when picking an infrastructure boiler-plate.</p>
                    ...
                    <p>With node and npm, you can now set up your boiler-plate and get started with your area's application</p>
                    <div className="instruction-text">
                      ...
                      <pre>
                        <code className="language-javascript">npx create-react-app my-app //this will temporarily install an instance create-react-app then run it</code><br/>
                        <code className="language-javascript">cd name_of_your_application && yarn start</code><br/>
                      </pre>
                    </div>
                    <div className="border"/>
                    ...
                    <div className="instruction-text">
                      ...
                      <pre><code className="language-javascript">yarn add redux react-redux @cjdev/visual-stack @cjdev/visual-stack-redux --dev</code></pre>
                    </div>
                    <div className="border"/>
