        ...
        {snippets =>
            <div>
              <Panel>
                <Body>
                  <Text>
                    Primitive layout component that renders a flex container with standardized styling props.
                  </Text>
                </Body>
              </Panel>
              <Panel>
              ...
              <Panel>
                ...
                <Body>
                  {/* s12:start */}
                  <Box direction="row">
                    <Box border paddingRight>Lorem Ipsum</Box>
                    <Text>Lorem ipsum</Text>
                  </Box>
                  {/* s12:end */}
                  ...
                  {/* s13:start */}
                  <Box direction="row">
                    <Box border paddingRight="small">Lorem Ipsum</Box>
                    <Text>Lorem ipsum</Text>
                  </Box>
                  {/* s13:end */}
                  ...
                  {/* s14:start */}
                  <Box direction="row">
                    <Box border paddingRight="large">Lorem Ipsum</Box>
                    <Text>Lorem ipsum</Text>
                  </Box>
                  {/* s14:end */}
              ...
              <Panel>
                ...
                <Body>
                  {/* s15:start */}
                  <Box border paddingBottom>Lorem Ipsum</Box>
                  {/* s15:end */}
                  <Snippet tag="s15" src={snippets} />

                  {/* s16:start */}
                  <Box border paddingBottom="small">Lorem Ipsum</Box>
                  {/* s16:end */}
                  <Snippet tag="s16" src={snippets} />

                  {/* s17:start */}
                  <Box border paddingBottom="large">Lorem Ipsum</Box>
                  {/* s17:end */}
              ...
              <Panel>
                ...
                <Body>
                  {/* s18:start */}
                  <Box border paddingTop>Lorem Ipsum</Box>
                  {/* s18:end */}
                  <Snippet tag="s18" src={snippets} />

                  {/* s19:start */}
                  <Box border paddingTop="small">Lorem Ipsum</Box>
                  {/* s19:end */}
                  <Snippet tag="s19" src={snippets} />

                  {/* s20:start */}
                  <Box border paddingTop="large">Lorem Ipsum</Box>
                  {/* s20:end */}
              ...
              <Panel>
                ...
                <Body>
                  {/* s21:start */}
                  <Box gap>
                    <Box border padding><Text>Lorem Ipsum</Text></Box>
                    <Box border padding><Text>Lorem Ipsum</Text></Box>
                    <Box border padding><Text>Lorem Ipsum</Text></Box>
                    <Box border padding><Text>Lorem Ipsum</Text></Box>
                  </Box>
              ...
              <Panel>
                ...
                <Body>
                  ...
                  <Box gap>
                    <Box border padding><Text>Lorem Ipsum</Text></Box>
                    <Box border grow padding justifyContent="center"><Text>Lorem Ipsum</Text></Box>
                  </Box>
                  {/* s29:end */}
