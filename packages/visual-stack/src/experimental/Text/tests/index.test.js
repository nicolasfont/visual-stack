...
describe('Text', () => {
  ...
  describe("Italic", () => {
    it("should render text italic", () => {
      ...
      expect(wrapper.find('.vs-text.vs-text-italic').text()).toEqual('Lorem ipsum');
    });
    it("should render text type h4 and italic", () => {
      const wrapper = mount(<Text type="h4" italic>Lorem ipsum</Text>);

      expect(wrapper.find('.vs-text.vs-text-type-h4.vs-text-italic').text()).toEqual('Lorem ipsum');
    });
  });
});
