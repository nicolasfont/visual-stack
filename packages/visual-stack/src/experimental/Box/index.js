...
const Box = ({ alignItems, border, children, className, direction, gap, grow, justifyContent, padding, paddingBottom, paddingLeft, paddingRight, paddingTop }) => {
  const classes = classNames(
    ...
    paddingBottom && `vs-box-padding-bottom-${paddingBottom === true ? "default" : paddingBottom}`,
    paddingLeft && `vs-box-padding-left-${paddingLeft === true ? "default" : paddingLeft}`,
    paddingRight && `vs-box-padding-right-${paddingRight== true ? "default" : paddingRight}`,
    paddingTop && `vs-box-padding-top-${paddingTop === true ? "default" : paddingTop}`,
