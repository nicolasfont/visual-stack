...
describe('Box', () => {
  ...
  it("should render children with direction column", () => {
    const wrapper = mount(<Box direction="column"><span>Lorem ipsum</span><button>OK</button></Box>);
    expect(wrapper.find('.vs-box.vs-box-direction-column span').text()).toEqual('Lorem ipsum');
    expect(wrapper.find('.vs-box.vs-box-direction-column button').text()).toEqual('OK');
  });
  it("should render children with direction row", () => {
    const wrapper = mount(<Box direction="row"><span>Lorem ipsum</span><button>OK</button></Box>);
    expect(wrapper.find('.vs-box.vs-box-direction-row span').text()).toEqual('Lorem ipsum');
    expect(wrapper.find('.vs-box.vs-box-direction-row button').text()).toEqual('OK');
  });
