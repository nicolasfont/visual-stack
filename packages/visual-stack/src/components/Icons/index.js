...
export const CodeIcon = () =>
	<Icon>
		<path class="code-chevron-left" fill="#49C5B1" d="M9,17c-0.2,0-0.4-0.1-0.6-0.2l-6-4C2.2,12.6,2,12.3,2,12s0.2-0.6,0.4-0.8l6-4C8.9,6.9,9.5,7,9.8,7.4 c0.3,0.5,0.2,1.1-0.3,1.4L4.8,12l4.8,3.2c0.5,0.3,0.6,0.9,0.3,1.4C9.6,16.8,9.3,17,9,17z"/>
		<path class="code-chevron-right" fill="#254A5D" d="M15,17c-0.3,0-0.6-0.2-0.8-0.4c-0.3-0.5-0.2-1.1,0.3-1.4l4.8-3.2l-4.8-3.2c-0.5-0.3-0.6-0.9-0.3-1.4 c0.3-0.5,0.9-0.6,1.4-0.3l6,4c0.3,0.2,0.4,0.5,0.4,0.8s-0.2,0.6-0.4,0.8l-6,4C15.4,16.9,15.2,17,15,17z"/>
	</Icon>;

export const DocIcon = () =>
	<Icon>
		<path class="doc-bg" fill="#FFFFFF" d="M14,2H6C4.9,2,4,2.9,4,4v16c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V8L14,2z"/>
		<path class="doc-outline" fill="#254A5D" d="M14,2H6C4.9,2,4,2.9,4,4v16c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V8L14,2z M18,20H6V4h7v5h5V20z"/>
		<path class="doc-text" fill="#49C5B1" d="M15,16H9c-0.6,0-1,0.4-1,1s0.4,1,1,1h6c0.6,0,1-0.4,1-1S15.6,16,15,16z"/>
		<path class="doc-text" fill="#49C5B1" d="M9,14h6c0.6,0,1-0.4,1-1s-0.4-1-1-1H9c-0.6,0-1,0.4-1,1S8.4,14,9,14z"/>
	</Icon>;

export const TokenIcon = () =>
	<Icon>
		<path class="icon-token-outline" fill="#254A5D" d="M12,23.5C5.7,23.5,0.5,18.3,0.5,12C0.5,5.7,5.7,0.5,12,0.5c6.3,0,11.5,5.2,11.5,11.5 C23.5,18.3,18.3,23.5,12,23.5z M12,2.5c-5.2,0-9.5,4.3-9.5,9.5s4.3,9.5,9.5,9.5s9.5-4.3,9.5-9.5S17.2,2.5,12,2.5z"/>
		<path class="icon-token-key" fill="#49C5B1" d="M12.3,10.8C11.8,9.5,10.5,8.5,9,8.5c-1.9,0-3.5,1.6-3.5,3.5s1.6,3.5,3.5,3.5c1.5,0,2.8-1,3.3-2.3h2.5 v2.3h2.3v-2.3h1.2v-2.3H12.3z M9,13.2c-0.6,0-1.2-0.5-1.2-1.2s0.5-1.2,1.2-1.2s1.2,0.5,1.2,1.2S9.6,13.2,9,13.2z"/>
	</Icon>;

export const LegacyIcon = () =>
	<Icon>
		<path class="archive-bg" fill="#ffffff" points="3,4.5 3,8.5 5,8.5 5,19.5 19,19.5 19,8.5 21,8.5 21,4.5 "/>
		<path class="archive-outline" fill="#254A5D" d="M21,3.5H3c-0.6,0-1,0.4-1,1v4c0,0.6,0.4,1,1,1h1v10c0,0.6,0.4,1,1,1h14c0.6,0,1-0.4,1-1v-10h1 c0.6,0,1-0.4,1-1v-4C22,3.9,21.6,3.5,21,3.5z M18,18.5H6v-9h12V18.5z M20,7.5H4v-2h16V7.5z"/>
		<path class="archive-handle" fill="#49C5B1" d="M14,12.5h-4c-0.6,0-1-0.4-1-1s0.4-1,1-1h4c0.6,0,1,0.4,1,1S14.6,12.5,14,12.5z"/>
	</Icon>;
