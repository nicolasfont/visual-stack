...
describe('TabLayout', () => {
  ...
  describe('functionaltesty', () => {
    ...
    test('should render child tabs', () => {
      ...
      expect(
        R.map(label => label.text(), wrapper.find('.vs-tab-label'))
      ).toEqual(['Tab1', 'Tab2', 'Tab3']);
      ...
      ).toEqual(['Tab Content 1', 'Tab Content 2', 'Tab Content 3']);
    });
  ...
  describe('styling', () => {
    test('should render tab underline with theme color when tab selected', () => {
      ...
      expect(tabLabelContentWrapper.props().style).toEqual({
    ...
    test('should highlight text on hover', () => {
      ...
      expect(
        wrapper
          ...
          .at(1)
          .props().style
      ).toEqual({ color: '#49c5b1', cursor: 'pointer' });
    ...
    test('should take custom accent color', () => {
      ...
      expect(
        wrapper
          ...
          .at(1)
          .props().style
      ).toEqual({ color: themeColor, cursor: 'pointer' });
    });
